...
namespace bookstore.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdPub,name,phone,address")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdPub,name,phone,address")] Publisher publisher)
        {
            if (ModelState.IsValid)
            {
